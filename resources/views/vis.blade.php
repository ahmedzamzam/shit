...
<div class="section section-breadcrumbs">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 dir="rtl"  style="font-family: 'Baloo Bhaijaan', cursive; " >الفديو التسويقى </h1>
            </div>
...
<div class="section">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <h3 dir="rtl"   style="font-family: 'Baloo Bhaijaan', cursive; "> </h3>
            </div>

            <p dir="rtl"   style="font-family: 'Baloo Bhaijaan', cursive ; text-align: center ; ">
                اداه ممتاذه للعميل حيث يقدم للعميل كل ما يرد بالصوت و الصوره فى مده تترواح من دقيقه الى 5 دقائق
                و يتم توضيح نشاطك بصوره لائقه و جميله
                الفكرة البيعية للاعلان الفيديو التسويقي هى الاساس فى عملية التسويق والترويج للمنتج او الخدمة،ولذا فهى تؤدى الى تحريك عملية البيع بشكل سريع
                فكرة سيناريو الفيلم التسويقى ايضاً تساهم فى قناعة المشاهد بالمنتج او الخدمة وبالتالى ترجمة هذه القناعة لعملية شراء او قرار بالتعامل
                افكار واكثر ، تركز على ابداع فكرة العمل وقياس تأثيرها قبل التنفيذ للتأكد من تحقيقها للأهداف البيعية المطلوبة.
            </p>
