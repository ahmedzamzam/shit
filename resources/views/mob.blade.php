...
<div class="section section-breadcrumbs">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 dir="rtl"  style="font-family: 'Baloo Bhaijaan', cursive; " >رسائل موبيل اعلانيه </h1>
            </div>
...
<div class="section">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <h3 dir="rtl"   style="font-family: 'Baloo Bhaijaan', cursive; ">صبح التسويق بستخدام الموبيل من افضل و اسرع الوسائل للوصل للعميل  </h3>
            </div>

            <p dir="rtl"   style="font-family: 'Baloo Bhaijaan', cursive ; text-align: center ; ">
                مع وجود الاندريود و ios
                اصبح التسويق بستخدام الموبيل من افضل و اسرع الوسائل للوصل للعميل
                دايموند  تقدم كثير من الوسائل الى تضمن لك وصولك للشريحه المستهدف الخاصه بعملك بمعنى
                اختيار الداتا المستخدمه بحرص شديد للوصل للعميل الممستهدف و تحقيق اعلى النتائج و نقدم الخدمات ارسال الرسايل وتس او موبيل  او رسائل فيس بوك
                حسب احتياجك
            </p>
